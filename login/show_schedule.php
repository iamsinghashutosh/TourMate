...
# @Date:   2020-11-06T02:14:53+05:30
# @Last modified by:   ashutosh
# @Last modified time: 2020-11-10T23:46:40+05:30
...
$message = '';
$gmap="https://www.google.com/maps/search/?api=AIzaSyDwXXOsDR16zshfbHsqdifg7ewVNkJJzQw&query=";
$rest=explode(',', $venues);
for($i = 1; $i < $_SESSION['index']; $i++){

  $gmap="<tabel border=\"1\"><tr><th>".$rest[$i]."</th><th></th></tr><tr><td></td></tr><tr><td>"."https://www.google.com/maps/search/?api=AIzaSyDwXXOsDR16zshfbHsqdifg7ewVNkJJzQw&query=".$_SESSION['lat'][$_SESSION['ival']].','.$_SESSION['lng'][$_SESSION['ival']].PHP_EOL.'</tabel>';
	//$gmap="hello";
  $message.=$gmap.' ';
	$_SESSION['ival'] = $_SESSION['ival'] + 1;
}
...
<!DOCTYPE html>
		...
		<!-- Header -->
		<div class="header">
			<a href="home.php" class="logo">Tour Mate</a>
...
//calculates distance between two points in km's
	...
	//		btn.setAttribute("class","btnsize");
          ...
          <script async defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDwXXOsDR16zshfbHsqdifg7ewVNkJJzQw&callback=initMap&libraries=geometry">
            </script>
